...
class ProcessBuilder {
    ...
    build() {
        ...
        logger.info('PISTAK', {
            java: 'C:/Users/ignac/AppData/Roaming/.minecraft/versions/1.12.2/1.12.2.jar',
            args: args,
            other: {
                cwd: this.gameDir,
        ...
        const child = child_process.spawn('C:/Users/ignac/AppData/Roaming/.minecraft/versions/1.12.2/1.12.2.jar', args, {
            cwd: this.gameDir,
            detached: ConfigManager.getLaunchDetached()
        })
